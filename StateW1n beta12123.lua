...
local text1 = ui.new_label('AA', 'Anti-aimbot angles', 'StateW1n.pub \bBeta ~ \a3498dbffVersion 1.1 ', 'string')
local text2 = ui.new_label('AA', 'Anti-aimbot angles', 'last update ~ 23.10.2025', 'string')
local text3 = ui.new_label('AA', 'Anti-aimbot angles', 'if you find a bug, write to telegram @statew1n', 'string')
local text4 = ui.new_label('AA', 'Anti-aimbot angles', 'hrisitosense.top is best crack skeet', 'string')
local text5 = ui.new_label('AA', 'Anti-aimbot angles', 'Creator: dafer1337', 'string')
...
-- Добавлен Trash Talk и Watermark
...
local function on_player_death(e)
    ...
    if attacker == local_player and victim ~= local_player then
        local messages = {
            "best lua for GS - StateW1n",
            "Best lua for GS in tg - @statew1n",
            "https://hrisitosense.top/forums/viewscript.php?id=147"
        }
...
local function on_paint()
    ...
    local r2, g2, b2, a2 = 41, 128, 185, 255  -- Темно-синий для анимации
    ...
    renderer.text(width - (width-950), height - 500, r, g, b, 255, "c", 0, output .. ' \a3498dbFF\bV1,1 ')
end
...
client.set_event_callback('paint_ui', function()
    ...
    if ui.is_menu_open() then
        ...
        -- Добавлена видимость Trash Talk и Watermark
...
default_btn = ui.new_button("AA", "Anti-aimbot angles", "Default Config", function() 
    import('')
end)
        ...
        for tick, data in pairs(queue) do
            if globals.curtime() <= data[4] then
                ...
                if x1 ~= nil and y1 ~= nil then
                    renderer.line(x1 - 6, y1, x1 + 6, y1, 52, 152, 219, 255)  -- Синий цвет
                    renderer.line(x1, y1 - 6, x1, y1 + 6, 93, 173, 226, 255)  -- Светло-синий цвет
                end
            end
        end
    end
